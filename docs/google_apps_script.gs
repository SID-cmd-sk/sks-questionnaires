...
function handleSheetAppend(data) {
    try {
        ...
        if (s === "pending")
            cell.setBackground("#FFF8E1").setFontColor("#D4A000");
        if (s === "in_progress")
            cell.setBackground("#E3F2FD").setFontColor("#006FA6");
        if (s === "delivered")
            cell.setBackground("#E8F5E9").setFontColor("#00A86B");
...
function getSpreadsheet() {
    ...
    if (!ss)
        throw new Error("Set SPREADSHEET_ID for standalone deployment.");
    return ss;
}
