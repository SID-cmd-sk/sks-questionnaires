-- ============================================================
-- SKS Scantech — Supabase Patch (idempotent version)
-- Run this in Supabase SQL Editor (Dashboard → SQL Editor)
-- Fixes dashboard "Update Status" button
--
-- NOTE: If you already ran schema.sql, this patch previously
-- failed with "policy already exists" for allow_public_update_requests.
-- Fixed below using DROP IF EXISTS before CREATE.
-- ============================================================
